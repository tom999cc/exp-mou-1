...
<body id="kt_body" class="header-mobile-fixed subheader-enabled subheader-fixed aside-enabled aside-fixed aside-minimize-hoverable page-loading" style="padding-top: 7rem;">
        ...
        <div class="aside aside-left aside-fixed d-flex flex-column flex-row-auto" id="kt_aside">
            ...
            <div class="aside-menu-wrapper flex-column-fluid" id="kt_aside_menu_wrapper">
                ...
                <div id="kt_aside_menu" class="aside-menu" data-menu-vertical="1" data-menu-scroll="1"
                    ...
                    <!--begin::Menu Nav-->
                    <ul class="menu-nav pt-1">
                        <li class="menu-item menu-item-active" aria-haspopup="true">
                            <a href="<?php echo $GLOBALS['path'];?>/" class="menu-link">
...
<!--                            <a href=?url=product/view.php&title=จัดการสินค้า" class="menu-link menu-toggle">-->
										<span class="svg-icon menu-icon">
                                ...
                                <span class="menu-text">จัดการสินค้า</span>
                            </a>
                        </li>
                        ...
                        <li class="menu-item menu-item-submenu" aria-haspopup="true" data-menu-toggle="hover">
                            <a href="#" class="menu-link menu-toggle">
                                ...
                                <span class="menu-text">ข้อมูลนายจ้าง</span>
                                ...
                                <ul class="menu-subnav">
                                    <li class="menu-item" aria-haspopup="true">
                                        <a href="#" class="menu-link">
                                            ...
                                            <span class="menu-text">จัดการข้อมูลนายจ้าง</span>
                                        </a>
                                    </li>
                                    <li class="menu-item" aria-haspopup="true">
                                        <a href="#" class="menu-link">
                                            ...
                                            <span class="menu-text">จัดการข้อมูลโรงงาน</span>
                                        </a>
                                    </li>
                                </ul>
                            </div>
                        ...
                        <li class="menu-item menu-item-submenu" aria-haspopup="true" data-menu-toggle="hover">
                            <a href="labor" class="menu-link menu-toggle">
                                ...
                                <span class="menu-text">จัดการข้อมูลแรงงาน</span>
                            </a>
                        </li>

                        <li class="menu-item menu-item-submenu" aria-haspopup="true" data-menu-toggle="hover">
                            <a href="officer" class="menu-link menu-toggle">
                                <span class="svg-icon menu-icon">
											<i class="flaticon2-user"></i>
										</span>
                                <span class="menu-text">จัดการข้อมูลเจ้าหน้าที่</span>
                            </a>
                        </li>
        ...
        <!--end::Aside-->
        <!--begin::Wrapper-->
        <div class="d-flex flex-column flex-row-fluid wrapper" style="padding-top: 0rem;" id="kt_wrapper">
            <!--begin::Header-->
...
<script type="application/javascript">
    function alertSaveData(){
        ...
        toastr.success("Save data successfully", "บันทึกข้อมูลสำเร็จ");
    }
